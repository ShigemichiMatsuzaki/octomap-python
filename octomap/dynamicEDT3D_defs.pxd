...
cdef extern from "dynamicEDT3D/dynamicEDTOctomap.h":
    ...
    cdef cppclass DynamicEDTSemanticOctomap:
        DynamicEDTSemanticOctomap(float maxdist, SemanticOcTree *_octree, point3d bbxMin, point3d bbxMax, bool treatUnknownAsOccupied)
        bool checkConsistency()
        float getDistance(point3d& p)
        float getDistance(OcTreeKey& k)
        float getMaxDist()
